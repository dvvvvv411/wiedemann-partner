      ...
      <div className="py-20" style={{ backgroundColor: '#f8f9fa' }}>
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="text-foreground text-lg leading-relaxed space-y-6 max-w-5xl mx-auto">
            <p>
              Was 2019 als Vision begann, ist heute Realität: Wiedemann und Partner hat sich zu einer führenden Kanzlei mit hochspezialisierten Rechtsexperten entwickelt, die deutschlandweit Mandanten betreuen.
            </p>
            <p>
              ...
              Sie finden uns zentral und gut erreichbar in Aachen, Eupener Str. 181.
            </p>
            ...
            <p>
              „Exzellenz entsteht nur dort, wo Leidenschaft auf Kompetenz trifft." Diese Philosophie prägt jeden Tag unserer Arbeit bei Wiedemann und Partner.
            </p>
            
            <p>
              Unser Team besteht aus überzeugten Juristen, die bewusst den Weg der spezialisierten Beratung gewählt haben. Obwohl unsere Qualifikationen auch andere Karrierewege ermöglicht hätten, haben wir uns für Wiedemann und Partner entschieden - weil hier unsere Vision von erstklassiger Rechtsberatung Realität wird.
            </p>
            
            <p>
              Diese innere Überzeugung spiegelt sich in unserem unermüdlichen Einsatz für Mandanten wider, in der juristischen Präzision unserer Arbeit und in unserem Anspruch, stets die bestmöglichen Ergebnisse zu erzielen. Das sind die Werte, die Wiedemann und Partner täglich zum Leben erweckt.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Wiedemann und Partner verbindet traditionelle Rechtsexpertise mit modernster Technologie. Unsere digitale Kanzleiführung ermöglicht es uns, effizienter zu arbeiten und bessere Ergebnisse für unsere Mandanten zu erzielen.
            </p>
            <br />
            <p className="text-xl text-white/90 leading-relaxed">
              Von Beginn an haben wir auf vollständige Digitalisierung gesetzt: intelligente Wissensdatenbanken, papierlose Prozesse und modernste Kommunikationstechnologie. Diese Infrastruktur ermöglicht uns flexible Arbeitsmodelle und schnelle Reaktionszeiten. So verbinden wir die Vorteile einer Aachener Präsenzkanzlei mit der Effizienz digitaler Arbeitsweisen - für eine Mandantenbetreuung, die neue Standards setzt.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-8">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-12 text-center leading-tight">
              Was Wiedemann und Partner einzigartig macht
            </h2>
            ...
            <div className="space-y-6">
              {[
                ...
                "Praxisnahe Lösungen: Unsere Beratung ist niemals abstrakt. Als Aachener sind wir fest verwurzelt, verstehen reale Herausforderungen und entwickeln pragmatische Lösungen mit echtem Mehrwert.",
