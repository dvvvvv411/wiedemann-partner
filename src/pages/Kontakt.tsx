            ...
            <div className="bg-gray-100 p-12">
              <div className="sticky top-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Wiedemann und Partner</h4>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">+49 241 94223033</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">+49 241 94223034</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">info@wiedemann-kanzlei.de</p>
                    </div>
                  </div>
